"""
routing/route_index_manager.py — FAISS route index management.

Builds a FAISS index from route_seeds.json for semantic route classification.
Uses sentence_transformers (same model as shared/semantic.py) with
_FallbackEmbedder fallback.
"""
...
class _FallbackEmbedder:
    """Hash-based fallback when sentence_transformers unavailable."""
