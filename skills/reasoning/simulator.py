#!/usr/bin/env python3
"""
simulator.py - 轻量级因果模拟引擎 — CognitiveLoop 使用的模拟推理组件
...
from core.llm_client import call as call_llm


class CausalSimulator:
    def __init__(self, core=None, llm=None):
        self.core = core
        self._llm = llm or call_llm
    ...
    def _simulate(self, scenario, time_horizon_hours, lightweight):
        ...
        return self._llm(prompt, temperature=0.3, max_tokens=max_tokens)
